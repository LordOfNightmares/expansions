...
function c22073844.initial_effect(c)
	...
	e0:SetCondition(function(e,tp,eg,ep,ev,re,r,rp) return Duel.IsExistingMatchingCard(cm.ndcfilter,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil) end)
	c:RegisterEffect(e0)
	--special summon
	...
	e3:SetTarget(c22073844.splimit)
	c:RegisterEffect(e3)
end
function c22073844.splimit(e,c)
	return not c:IsSetCard(0x145)
end
function c22073844.ndcfilter(c)
	return c:IsFaceup() and not c:IsSetCard(0x145)
end
