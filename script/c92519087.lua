...
function c92519087.initial_effect(c)
	...
	e1:SetCondition(c92519087.remcon)
...
function c92519087.ndcfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x14e)
end
function c92519087.remcon(e)
	return Duel.IsExistingMatchingCard(c92519087.ndcfilter,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
end
