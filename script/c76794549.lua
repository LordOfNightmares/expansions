...
function c76794549.ckeckcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c76794549.archfilter,1,nil)
end
function c76794549.archfilter(c)
	return c:IsSetCard(0xf8) or c:IsSetCard(0x98) or c:IsSetCard(0x99)
end
