...
function c98630720.initial_effect(c)
	--link summon
	aux.AddLinkProcedure(c,aux.FilterBoolFunction(Card.IsLinkType,TYPE_EFFECT),3,3,c98630720.lcheck)
	c:EnableReviveLimit()
	--indestructable
...
function c98630720.lcheck(g,lc)
	return (g:IsExists(Card.IsSetCard,1,nil,0x10f) and g:IsExists(Card.IsSetCard,1,nil,0x102))
		or g:IsExists(Card.IsSetCard,2,nil,0x10f) or g:IsExists(Card.IsSetCard,2,nil,0x102)
end
