...
function c28781003.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,c28781003.xyzfilter,4,2)
	c:EnableReviveLimit()
	--rank up/down
...
function c28781003.xyzfilter(g,c)
	return (g:IsExists(Card.IsSetCard,1,nil,0x10db) and g:IsExists(Card.IsSetCard,1,nil,0xba))
	or g:IsExists(Card.IsSetCard,2,nil,0x10db) or g:IsExists(Card.IsSetCard,2,nil,0xba) 
