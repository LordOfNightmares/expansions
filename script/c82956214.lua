...
function c82956214.desfilter(c,tp)
	return c:IsFaceup() and Duel.IsExistingMatchingCard(c82956214.tgfilter,tp,LOCATION_MZONE,0,1,nil,c:GetAttack())
end
function c82956214.tgfilter(c)
...
function c82956214.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		local g=Duel.SelectMatchingCard(tp,c82956214.tgfilter,tp,LOCATION_MZONE,0,1,1,nil,atk)
		local gc=g:GetFirst()
