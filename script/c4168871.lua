function c4168871.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(4168871,ACTIVITY_SPSUMMON,c4168871.chainfilter)
end
function c4168871.chainfilter(re,tp,cid)
    return not(re:GetHandler():IsSetCard(0x33))
end
...
function c4168871.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(4168871,tp,ACTIVITY_SPSUMMON)==0
