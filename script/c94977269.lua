...
function c94977269.initial_effect(c)
	...
	e2:SetCondition(c94977269.spcon)
...
function c94977269.ndcfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x9d)
end
function c94977269.ndcfilter2(c)
	return c:IsFaceup() and not c:IsSetCard(0x9d)
end
function c94977269.spcon(e,tp,eg,ep,ev,re,r,rp,chk)
	return Duel.IsExistingMatchingCard(c94977269.ndcfilter,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil)
	and not Duel.IsExistingMatchingCard(c94977269.ndcfilter2,e:GetHandler():GetControler(),LOCATION_MZONE,0,1,nil) 
end
