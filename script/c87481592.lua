...
function c87481592.tgcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return ec and c:IsReason(REASON_LOST_TARGET) and ec:IsReason(REASON_DESTROY) and ec:IsPreviousControler(tp) and ec:IsPreviousLocation(LOCATION_MZONE)
		and ((ec:IsReason(REASON_BATTLE) and Duel.GetAttacker():IsControler(1-tp))
		or (ec:IsReason(REASON_EFFECT) and ec:GetReasonPlayer()==1-tp))
end
