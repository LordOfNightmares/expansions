...
function cm.filtercost(g,k)
	return c:IsSetCard(0x9f) or c:IsSetCard(0x99) or c:IsSetCard(0x98)
end
function c11481610.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(cm.filtercost,tp,LOCATION_HAND,0,e:GetHandler())
